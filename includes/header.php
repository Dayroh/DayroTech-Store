...
<head>
    ...
    <link rel="icon" href="<?php echo BASE_URL; ?>assets/images/KTEE-LOGO-BG.png" type="image/x-icon">
    <!-- Bootstrap CSS -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="<?php echo BASE_URL; ?>">
                <img src="<?php echo BASE_URL; ?>assets/images/KTEE-LOGO-BG.png" alt="" height="40" class="me-2">
