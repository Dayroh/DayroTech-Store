...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="print.php?id=<?php echo $invoiceId; ?>" class="btn btn-primary me-2" target="_blank">
...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <img src="../assets/images/KTEE-LOGO-BG.png" alt="" height="60" class="mb-3">
                <p class="mb-1"><strong><?php echo COMPANY_NAME; ?></strong></p>
                <p class="mb-1">Computer Sales | ISP Services</p>
                <p class="mb-1">info@ktee.com</p>
                <p class="mb-0">+254 729 596 966</p>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-1"><strong><?php echo htmlspecialchars($invoice['name']); ?></strong></p>
                <?php if (!empty($invoice['company'])): ?>
                    <p class="mb-1"><?php echo htmlspecialchars($invoice['company']); ?></p>
                <?php endif; ?>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <p><?php echo $invoice['business_name']; ?></p>
            </div>
            <div class="col-md-3">
                <p class="mb-1"><strong>Date Issued:</strong></p>
                <p><?php echo date('M d, Y', strtotime($invoice['date_issued'])); ?></p>
            </div>
            <div class="col-md-3">
                <p class="mb-1"><strong>Due Date:</strong></p>
                <p><?php echo date('M d, Y', strtotime($invoice['due_date'])); ?></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <table class="table">
                    <tr>
                        <th>Subtotal:</th>
                        <td class="text-end">Ksh.<?php echo number_format($subtotal, 2); ?></td>
                    </tr>
                    <?php if ($invoice['tax_rate'] > 0): ?>
                        <tr>
                            <th>Tax (<?php echo $invoice['tax_rate']; ?>%):</th>
                            <td class="text-end">Ksh<?php echo number_format($taxAmount, 2); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if ($invoice['discount'] > 0): ?>
                        <tr>
                            <th>Discount:</th>
                            <td class="text-end">-Ksh<?php echo number_format($invoice['discount'], 2); ?></td>
                        </tr>
                    <?php endif; ?>
                    <tr class="table-active">
                        <th>Total:</th>
                        <td class="text-end fw-bold">Ksh<?php echo number_format($total, 2); ?></td>
                    </tr>
                </table>
            </div>
        </div>
